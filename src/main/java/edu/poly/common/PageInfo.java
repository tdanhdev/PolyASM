...
public class PageInfo {
	...
	static {
		...
		pageRoute.put(PageType.SITE_LOGIN_PAGE, new PageInfo("User", "/site/users/login.jsp", null));
		...
		pageRoute.put(PageType.SITE_EDIT_PROFILE_PAGE, new PageInfo("Edit Profilt", "/site/users/edit-profile.jsp", null));
		...
		pageRoute.put(PageType.SITE_VIDEO_DETAIL_PAGE, new PageInfo("Video Detail", "/site/videos/detail.jsp", null));
		pageRoute.put(PageType.SITE_SHARE_PAGE, new PageInfo("Shares", "/site/videos/share.jsp", null));
